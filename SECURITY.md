...
If you discover a security vulnerability in Eagle Eye, please report it responsibly:

1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/hiatech/eagle-eye/security/advisories/new) to submit your report directly through the repository.
...
Eagle Eye is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- Eagle Eye aggregates publicly available OSINT data
...
- Vulnerabilities in the Eagle Eye codebase
...
Thank you for helping keep Eagle Eye and its users safe! 🔒
