...
describe('Market breadth RPC handler', () => {
  const handlerSrc = readFileSync(join(root, 'server', 'eagleeye', 'market', 'v1', 'get-market-breadth-history.ts'), 'utf-8');
...
describe('Market breadth proto', () => {
  const protoSrc = readFileSync(join(root, 'proto', 'eagleeye', 'market', 'v1', 'get_market_breadth_history.proto'), 'utf-8');
  const serviceSrc = readFileSync(join(root, 'proto', 'eagleeye', 'market', 'v1', 'service.proto'), 'utf-8');
...
describe('Market breadth panel', () => {
  ...
  it('is registered in handler.ts', () => {
    const handlerTs = readFileSync(join(root, 'server', 'eagleeye', 'market', 'v1', 'handler.ts'), 'utf-8');
