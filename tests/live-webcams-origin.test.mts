...
describe('LiveWebcamsPanel postMessage origin guard', () => {
  it('accepts YouTube iframe API messages from the iframe embed origin', () => {
    const src = 'https://www.youtube.com/embed/e34xb-Fbl0U?enablejsapi=1&origin=https://eagle-eye.app';
  ...
  it('accepts YouTube nocookie messages only when the iframe uses nocookie', () => {
    const src = 'https://www.youtube-nocookie.com/embed/e34xb-Fbl0U?enablejsapi=1&origin=https://eagle-eye.app';
  ...
  it('rejects same-window messages after a child frame navigates to an unexpected origin', () => {
    const originalSrc = 'https://www.youtube.com/embed/e34xb-Fbl0U?enablejsapi=1&origin=https://eagle-eye.app';
