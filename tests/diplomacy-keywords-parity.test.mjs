...
test('server/eagleeye/news/v1/list-feed-digest.ts sources keywords from canonical JSON', async () => {
  const src = await readFromRoot('server/eagleeye/news/v1/list-feed-digest.ts');
  assert.match(
    src,
