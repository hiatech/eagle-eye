...
import { detectTrafficAnomaly } from '../server/eagleeye/supply-chain/v1/_scoring.mjs';
import {
  CANONICAL_CHOKEPOINTS,
  corridorRiskNameToId,
} from '../server/eagleeye/supply-chain/v1/_chokepoint-ids.ts';

const __dirname = dirname(fileURLToPath(import.meta.url));
const root = resolve(__dirname, '..');
const relaySrc = readFileSync(resolve(root, 'scripts/ais-relay.cjs'), 'utf-8');
const handlerSrc = readFileSync(resolve(root, 'server/eagleeye/supply-chain/v1/get-chokepoint-status.ts'), 'utf-8');
