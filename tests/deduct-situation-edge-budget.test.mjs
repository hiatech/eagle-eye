...
// nothing cached (EAGLEEYE-VP, #5147).
//
...
const src = readFileSync(
  resolve(__dirname, '../server/eagleeye/intelligence/v1/deduct-situation.ts'),
  'utf-8',
);
...
describe('deduct-situation edge response budget (EAGLEEYE-VP / #5147)', () => {
