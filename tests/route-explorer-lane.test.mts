...
import { computeLane } from '../server/eagleeye/supply-chain/v1/get-route-explorer-lane.ts';
import type { GetRouteExplorerLaneRequest } from '../src/generated/server/eagleeye/supply_chain/v1/service_server.ts';
