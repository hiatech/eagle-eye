...
import { assignStoryIdentity, deduplicateHeadlines } from '../server/eagleeye/news/v1/dedup.mjs';
...
import { adoptExistingCanonical } from '../server/eagleeye/news/v1/dedup.mjs';
