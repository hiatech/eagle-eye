...
export const CHINA_ACTIVITY_PROXY_REGISTRY: readonly Readonly<ChinaActivityProxyDefinition>[] =
  Object.freeze([
    ...
    proxyDefinition({
      ...
      source: {
        publisherId: 'publisher:eagleeye-energy-spine',
        publisherName: 'EagleEye energy spine',
        url: 'https://www.eagle-eye.app/docs/data-sources',
    ...
    proxyDefinition({
      ...
      source: {
        publisherId: 'publisher:eagleeye-china-corridors',
        publisherName: 'EagleEye China corridor control towers',
        url: 'https://www.eagle-eye.app/docs/data-sources',
