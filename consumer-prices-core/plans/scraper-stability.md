...
- src/snapshots/eagleeye.ts: retailer spread query — add AND pm.pin_disabled_at IS NULL
...
snapshots/eagleeye.ts buildRetailerSpreadSnapshot:
...
In eagleeye repo: src/services/consumer-prices/index.ts
...
21. Separate PR in eagleeye repo: remove ke from MARKETS (Task 11)
