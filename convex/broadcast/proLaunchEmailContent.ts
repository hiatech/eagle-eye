...
export const PRO_LAUNCH_FROM = "Elie from EagleEye <news@eagle-eye.app>";
export const PRO_LAUNCH_REPLY_TO = "elie@eagle-eye.app";
export const PRO_LAUNCH_SUBJECT = "You waitlisted EagleEye PRO. It's now live.";
...
export const PRO_LAUNCH_UPGRADE_URL =
  "https://eagle-eye.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=launch-email";

// CAN-SPAM physical address. Required in every commercial email footer.
// Update if the company physical address changes.
export const PRO_LAUNCH_PHYSICAL_ADDRESS = "EagleEye FZ LLC, Dubai - United Arab Emirates";
 ...
 */
export const PRO_LAUNCH_TEXT = `I'm Elie, founder of EagleEye. PRO launched today (https://eagle-eye.app/pro). I'm writing because you signed up a month ago, when the product was smaller and different.

Here's what it is now.

EagleEye stopped being only a real-time monitoring dashboard, though it still excels at that. It's also a research tool now. It tracks what's happening, and it forecasts what happens next: scenario probabilities on conflicts, market reactions to headlines, supply-chain shock paths, country stability trajectories. You read the present and stress-test the future in the same place.
...
It grew a dedicated energy variant. energy.eagle-eye.app: live traffic and exposure on the four major shipping chokepoints, tanker positions in real time, 631 oil and gas pipelines mapped, global strategic storage atlas, refinery utilization, retail fuel prices.
...
Native AI context. MCP server plus a 27-endpoint REST API — full docs at https://eagle-eye.app/docs/documentation. Plug it into Claude, ChatGPT, Cursor, or anything you're building.
...
→ Upgrade to PRO: https://eagle-eye.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=launch-email
...
<p>I'm Elie, founder of EagleEye. <a href="https://eagle-eye.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=opener" style="color:#0066cc;">PRO launched today</a>. I'm writing because you signed up a month ago, when the product was smaller and different.</p>
<p>Here's what it is now.</p>
<p>EagleEye stopped being only a real-time monitoring dashboard, though it still excels at that. It's also a research tool now. It tracks what's happening, and it forecasts what happens next: scenario probabilities on conflicts, market reactions to headlines, supply-chain shock paths, country stability trajectories. You read the present and stress-test the future in the same place.</p>
<p><strong>The dashboard grew sideways.</strong> Conflicts stream live alongside sanctions, regime shifts, GPS jamming, displacement, climate anomalies. Bilateral trade flows, tariff trends, chokepoint indices, route disruption, cost-shock simulations, stability scoring across 137 countries with deep coverage on 40+ indicators. AI stock analysis with price targets, backtesting, a scanner for tickers trending on Reddit. Live aircraft tracking, civilian and military: fighter scrambles over the Taiwan Strait, carrier strike groups in the Persian Gulf, special-ops by callsign, 100+ airports for delays and cascades. Useful when something breaks at 3 a.m. and a price chart won't tell you why.</p>
<p><strong>It grew a dedicated energy variant.</strong> <a href="https://energy.eagle-eye.app" style="color:#0066cc;">energy.eagle-eye.app</a>: live traffic and exposure on the four major shipping chokepoints, tanker positions in real time, 631 oil and gas pipelines mapped, global strategic storage atlas, refinery utilization, retail fuel prices.</p>
...
<p><strong>Native AI context.</strong> MCP server plus a 27-endpoint REST API — <a href="https://eagle-eye.app/docs/documentation" style="color:#0066cc;">full docs</a>. Plug it into Claude, ChatGPT, Cursor, or anything you're building.</p>
<p>Also included:</p>
...
<a href="https://eagle-eye.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=cta-button" style="display:inline-block;background:#111;color:#ffffff;text-decoration:none;padding:14px 28px;border-radius:6px;font-weight:600;">Upgrade to PRO with EARLYWM30 →</a>
</p>
