 ...
 *
 * Every definition is sourced from EagleEye's own methodology docs or
...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  // ── Scoring & Indices ─────────────────────────────────────────────
  {
    ...
    learnMore: [
      { label: 'CII methodology', href: 'https://www.eagle-eye.app/docs/country-instability-index' },
      { label: 'CII methodology explainer (blog)', href: 'https://www.eagle-eye.app/blog/posts/country-instability-index-methodology-explained/' },
    ],
  },
  {
    ...
    learnMore: [
      { label: 'CRI methodology (full reference)', href: 'https://www.eagle-eye.app/docs/methodology/country-resilience-index' },
      { label: 'CRI methodology explainer (blog)', href: 'https://www.eagle-eye.app/blog/posts/country-resilience-index-methodology-explained/' },
    ],
  },
  {
    slug: 'strategic-risk',
    ...
    category: 'Scoring & Indices',
    short:
      'Strategic Risk is EagleEye’s composite triage layer that synthesizes instability, convergence, infrastructure, theater posture, sanctions, and breaking-news signals into a single headline risk read.',
    body: [
      'Strategic Risk is EagleEye’s composite triage layer for global risk. Its server-published headline score is a top-five Country Instability Index roll-up, around which the panel layers additional convergence, infrastructure cascade, theater posture, breaking-news, sanctions, and radiation-watch context.',
    ...
    learnMore: [
      { label: 'Strategic Risk methodology', href: 'https://www.eagle-eye.app/docs/strategic-risk' },
    ],
  },
  {
    ...
    learnMore: [
      { label: 'CRI methodology (coverage & imputation)', href: 'https://www.eagle-eye.app/docs/methodology/country-resilience-index' },
    ],
  },
  {
    ...
    body: [
      ...
      'In EagleEye it is one of several ambient indicators fused into the Strategic Risk context rather than a standalone forecast. It illustrates the platform’s broader thesis: correlating many weak, independent signals surfaces convergence earlier than any single authoritative source.',
    ],
  ...
  // ── Signals & Detection ───────────────────────────────────────────
  {
    ...
    body: [
      'Focal point detection is EagleEye’s intelligence-synthesis layer. A focal point is an entity — a person, place, or organization — that appears in both news coverage and map signals at the same time. Surfacing those overlaps identifies the "main characters" driving the current situation.',
    ...
    learnMore: [
      { label: 'AI intelligence methodology', href: 'https://www.eagle-eye.app/docs/ai-intelligence' },
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      'An infrastructure cascade is a chain reaction across dependent critical systems. EagleEye models the dependency graph linking cables, pipelines, ports, and chokepoints so that damage or disruption at one node can be traced to the downstream nodes it puts at risk.',
    ...
    learnMore: [
      { label: 'Infrastructure cascade methodology', href: 'https://www.eagle-eye.app/docs/infrastructure-cascade' },
    ],
  },
  {
    slug: 'hotspot',
    ...
    body: [
      'A hotspot is a location EagleEye watches continuously. Crucially, a hotspot’s activity level is not a static threat rating — it is calculated in real time based on how strongly current news correlates with the keywords that define that location.',
    ...
    learnMore: [
      { label: 'Hotspots methodology', href: 'https://www.eagle-eye.app/docs/hotspots' },
    ],
  },
  {
    ...
    body: [
      'Threat classification is the step that turns raw incoming events into a structured, labelled feed. EagleEye uses a hybrid approach: fast rule-based tagging handles the common, unambiguous cases, while model-based classification handles nuance and ambiguity.',
  ...
  // ── Maritime & Chokepoints ────────────────────────────────────────
  {
    ...
    body: [
      ...
      'The essential idea is that a chokepoint is where geography removes optionality — the risk is not just today’s traffic, but how little room the system has when that traffic changes. EagleEye tracks 13 waterways, of which seven currently publish live flow estimates.',
    ],
    related: ['strait-of-hormuz', 'strait-of-malacca', 'suez-canal', 'ais', 'chokepoint-congestion'],
    learnMore: [
      { label: 'What is a maritime chokepoint? (blog)', href: 'https://www.eagle-eye.app/blog/posts/what-is-a-maritime-chokepoint/' },
      { label: 'Maritime intelligence methodology', href: 'https://www.eagle-eye.app/docs/maritime-intelligence' },
    ],
  },
  {
    ...
    body: [
      ...
      'In EagleEye, Hormuz is one of the chokepoints with live flow estimates: vessel activity, congestion, and disruption signals are correlated against energy markets so an operator can see whether a Gulf tension event has a plausible transmission path into oil and gas prices.',
    ],
    related: ['maritime-chokepoint', 'ais', 'chokepoint-congestion'],
    learnMore: [
      { label: 'Energy shock monitoring (blog)', href: 'https://www.eagle-eye.app/blog/posts/energy-shock-monitoring-chokepoints-eagle-eye/' },
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      'As a chokepoint, Suez concentrates a large share of Europe–Asia trade into a single canal; a blockage or a security threat that reroutes traffic around Africa adds days of transit and materially raises freight costs, which EagleEye tracks alongside the physical disruption signals.',
    ],
    related: ['maritime-chokepoint', 'strait-of-malacca', 'chokepoint-congestion'],
    learnMore: [
      { label: 'Tracking global trade routes (blog)', href: 'https://www.eagle-eye.app/blog/posts/tracking-global-trade-routes-chokepoints-freight-costs/' },
    ],
  },
  {
    slug: 'ais',
    ...
    body: [
      ...
      'EagleEye uses AIS positions to watch tanker and cargo movement inside chokepoint bounding boxes, detect congestion, and flag disruptions such as coverage gaps. Because AIS can be switched off or spoofed, sudden gaps are themselves treated as a signal worth surfacing.',
    ],
  ...
  },
  {
    ...
    body: [
      'Chokepoint congestion is an above-baseline accumulation of ships waiting to transit a strait or canal. EagleEye detects it from AIS activity inside each chokepoint’s bounding box and treats a congestion spike as one of its AIS disruption types.',
  ...
  // ── OSINT & Methodology ───────────────────────────────────────────
  {
    ...
    body: [
      ...
      'EagleEye is an OSINT platform by construction: every layer is sourced from public feeds with documented provenance, which is what lets it publish source-attributed briefs and scores that a reader can trace back to the underlying evidence.',
    ],
    related: ['provenance', 'world-brief', 'focal-point-detection'],
    learnMore: [
      { label: 'OSINT for everyone (blog)', href: 'https://www.eagle-eye.app/blog/posts/osint-for-everyone-open-source-intelligence-democratized/' },
    ],
  },
  {
    slug: 'provenance',
    ...
    body: [
      ...
      'EagleEye carries provenance through its briefs, scores, and cached operational data with documented methodology, so a reader — or an AI agent consuming the API — can see not just what the platform concluded but which sources support it.',
    ],
  ...
  },
  {
    ...
    category: 'OSINT & Methodology',
    short:
      'The World Brief is EagleEye’s AI-generated, source-attributed summary of the current global situation, synthesized from correlated live signals rather than a single news feed.',
    body: [
      'The World Brief is a source-attributed situational summary generated from EagleEye’s correlated live signals — news, map events, focal points, and classified threats. It answers "what is happening right now, globally" in a form an operator or an agent can consume directly.',
  ...
  },
  {
    ...
    body: [
      ...
      'EagleEye surfaces prediction-market context — for example via the get_prediction_markets tool — as an external probability signal to sit alongside its own scenario forecasts, giving a market-implied read on geopolitical questions next to the platform’s analysis.',
    ],
    related: ['world-brief', 'strategic-risk'],
    learnMore: [
      { label: 'Prediction markets & AI forecasting (blog)', href: 'https://www.eagle-eye.app/blog/posts/prediction-markets-ai-forecasting-geopolitics/' },
    ],
  },
];
