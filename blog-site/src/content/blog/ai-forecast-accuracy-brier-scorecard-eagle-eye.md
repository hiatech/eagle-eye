...
description: "EagleEye publishes a Brier-score audit of 32 AI forecasts, including calibration results, overconfidence patterns, and comparison with prediction markets."
metaTitle: "AI Forecast Accuracy & Brier Scorecard | EagleEye"
...
heroImage: "/blog/images/blog/ai-forecast-accuracy-brier-scorecard-eagle-eye.jpg"
pubDate: "2026-07-21"
...
In the forecast panel on the dashboard, and programmatically via the `get_forecast_scorecard` MCP tool or the forecast REST endpoints in the [API reference](https://www.eagle-eye.app/docs/api-reference).
