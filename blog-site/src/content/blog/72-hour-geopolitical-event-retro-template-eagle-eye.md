...
metaTitle: "72-Hour Geopolitical Event Retro Template | EagleEye"
...
heroImage: "/blog/images/blog/72-hour-geopolitical-event-retro-template-eagle-eye.jpg"
pubDate: "2026-06-13"
...
For EagleEye data, possible event boundaries include:
...
For the pre-event side of this workflow, pair the retro with the [supply-chain scenario engine](/blog/posts/stress-test-supply-chain-scenario-engine-eagle-eye/) and the [country risk monitoring workflow](/blog/posts/country-risk-monitoring-workflow-for-analysts/).

## Source transparency

EagleEye can support retros through chokepoint status, Scenario Engine templates, country risk, forecasts, market implications, disease and disaster panels, displacement summaries, security advisories, and news context. But the retro owner still needs to record which data was actually visible at the time.
