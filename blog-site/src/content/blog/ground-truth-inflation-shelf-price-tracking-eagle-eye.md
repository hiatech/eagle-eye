...
description: "EagleEye tracks supermarket shelf prices across four UAE retailers and compares them with the Big Mac Index, FAO food prices, fuel prices, and IMF CPI."
metaTitle: "Real-Time Shelf Price & Inflation Tracking | EagleEye"
...
heroImage: "/blog/images/blog/ground-truth-inflation-shelf-price-tracking-eagle-eye.jpg"
pubDate: "2026-07-21"
...
The interesting question — what do things actually cost, right now, on the shelf? — has a different answer. You collect the prices yourself. That's what EagleEye's consumer-prices system does.

## Shelf prices, scraped daily

The pilot market is the **United Arab Emirates**, where EagleEye tracks a defined essentials basket across **four major grocery retailers: Carrefour, Spinneys, Lulu, and Noon**. Real product pages, real listed prices — collected continuously and normalized into a comparable basket.
...
Yes — the `get_consumer_prices` MCP tool and the consumer-prices REST endpoints in the [API reference](https://www.eagle-eye.app/docs/api-reference) return the overview, categories, movers, and retailer spread as structured series.
