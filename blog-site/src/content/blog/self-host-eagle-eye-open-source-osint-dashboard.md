---
title: "Self-Host EagleEye: Run an Open Source OSINT Dashboard Locally"
description: "A practical overview of self-hosting EagleEye with Docker or Podman, required secrets, Redis, seeders, optional API keys, and AGPL responsibilities."
metaTitle: "Self-Host EagleEye OSINT Dashboard"
keywords: "self host EagleEye, open source OSINT dashboard, Docker OSINT dashboard, geopolitical dashboard self hosted, AGPL intelligence dashboard"
audience: "Developers, OSINT builders, platform teams, security researchers"
heroImage: "/blog/images/blog/self-host-eagle-eye-open-source-osint-dashboard.jpg"
pubDate: "2026-06-13"
modifiedDate: "2026-07-22"
---

EagleEye is open source, but "open source" does not automatically mean "safe to run on the public internet with defaults." A serious self-hosted intelligence dashboard needs secrets, seeders, Redis, source keys, and a clear understanding of which feeds are public, optional, or paid.
...
| Service | Purpose |
|---|---|
| `eagleeye` | nginx plus the Node.js API surface |
| `eagleeye-redis` | Redis data store |
| `eagleeye-redis-rest` | Upstash-compatible REST proxy |
| `eagleeye-ais-relay` | AISStream relay for vessel tracking when configured |
...
EagleEye works with many public sources, but some feeds need keys.
...
EagleEye is a real-time intelligence dashboard with many external dependencies. That means operational hygiene matters.

For developer context before you deploy, read the [developer API and open-source guide](/blog/posts/build-on-eagle-eye-developer-api-open-source/) and the [MCP server guide](/blog/posts/eagle-eye-mcp-server-ai-agents-real-time-intelligence/).
...
The deployment files and current setup instructions live in the public [EagleEye repository](https://github.com/hiatech/eagle-eye). Review the [GNU AGPL license text](https://www.gnu.org/licenses/agpl-3.0.html) alongside the repository's own licensing notes before operating a modified network service.

## Frequently Asked Questions

**Can I run EagleEye entirely offline?**
...
**Self-hosting EagleEye is not about cloning a website. It is about owning the data path, the secrets, and the operational tradeoffs behind your intelligence workspace.**
