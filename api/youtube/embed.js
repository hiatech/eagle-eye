...
const ALLOWED_ORIGINS = [
  /^https:\/\/(.*\.)?eagle-eye\.app$/,
  /^https:\/\/eagleeye-[a-z0-9-]+-elie-habib-projects\.vercel\.app$/,
  /^https:\/\/eagleeye-[a-z0-9-]+\.vercel\.app$/,
  /^https?:\/\/localhost(:\d+)?$/,
  /^https?:\/\/127\.0\.0\.1(:\d+)?$/,
  /^tauri:\/\/localhost$/,
];
...
function sanitizeOrigin(raw) {
  return sanitizeAllowedOrigin(raw, 'https://eagle-eye.app', ALLOWED_ORIGINS);
}
