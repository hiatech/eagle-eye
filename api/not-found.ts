...
export default function handler(req: Request): Response {
  ...
  const body = {
    error: {
      ...
      hint: 'Check the endpoint path against the OpenAPI spec at https://eagle-eye.app/openapi.yaml or the API reference at https://www.eagle-eye.app/docs/api-reference.',
    },
    documentation: 'https://www.eagle-eye.app/docs/api-reference',
  };
