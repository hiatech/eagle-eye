...
// SHARED app-shell foundation for the EagleEye interactive-dashboard fleet.
//
...
export const UI_CONNECT_DOMAINS = ['https://eagle-eye.app', 'https://www.eagle-eye.app'] as const;
