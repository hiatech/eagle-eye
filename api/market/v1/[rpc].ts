...
import { createMarketServiceRoutes } from '../../../src/generated/server/eagleeye/market/v1/service_server';
import { marketHandler } from '../../../server/eagleeye/market/v1/handler';
