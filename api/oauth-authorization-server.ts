 ...
 * host that terminates the request (apex eagle-eye.app, www, or
 * api.eagle-eye.app) returns self-consistent metadata whose `issuer` and
 ...
 * (https://workos.com/auth-md). EagleEye supports anonymous agent
