...
export default function handler(req, res) {
  const url = new URL(req.url, 'https://eagle-eye.app');
  ...
  const baseUrl = 'https://eagle-eye.app';
  ...
  const title = `${countryName} Intelligence Brief | Eagle Eye`;
...
<head>
  ...
  <meta name="twitter:site" content="@EagleEyeApp"/>
