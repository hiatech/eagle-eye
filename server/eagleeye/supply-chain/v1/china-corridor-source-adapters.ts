  ...
  for (const corridorId of CHINA_LOGISTICS_CORRIDOR_IDS) {
    ...
    signals.push(cycloneAvailable
      ? sourceSignal({
        ...
        publisher: {
          id: 'publisher:eagleeye-western-pacific-coverage',
          name: 'EagleEye Western Pacific hazard coverage',
          type: 'derived',
        },
        sourceUrl: null,
        sourceScope: 'regional',
...
function adaptEnergy(
  ...
  if (!payload) {
    return family('china-energy-spine', [unavailableSignal({
      ...
      publisher: {
        id: 'publisher:eagleeye-energy-spine',
        name: 'EagleEye energy spine',
        type: 'derived',
      },
      sourceUrl: null,
