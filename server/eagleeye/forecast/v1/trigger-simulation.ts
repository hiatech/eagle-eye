...
} from '../../../../src/generated/server/eagleeye/forecast/v1/service_server';
import { ApiError } from '../../../../src/generated/server/eagleeye/forecast/v1/service_server';
...
export async function triggerSimulation(
  ...
  const apiKeyHeader = ctx.request.headers.get('x-api-key') || ctx.request.headers.get('x-eagleeye-key') || '';
