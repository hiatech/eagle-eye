...
async function sendNotificationEmail(
  ...
  const notifyEmail = process.env.CONTACT_NOTIFY_EMAIL || 'elie@eagle-eye.app';
      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family: -apple-system, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p style="color: #999; font-size: 12px; margin-top: 24px;">Sent from eagle-eye.app enterprise contact form</p>
          </div>`,
      }),
    });
    if (!res.ok) {
