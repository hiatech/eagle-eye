...
} from '../../../../src/generated/server/eagleeye/leads/v1/service_server';
import { ApiError, ValidationError } from '../../../../src/generated/server/eagleeye/leads/v1/service_server';
...
export const DESKTOP_AUTH_TIMESTAMP_HEADER = 'x-eagleeye-desktop-timestamp';
export const DESKTOP_AUTH_SIGNATURE_HEADER = 'x-eagleeye-desktop-signature';
...
async function sendConfirmationEmail(email: string, referralCode: string): Promise<void> {
  const referralLink = `https://eagle-eye.app/pro?ref=${referralCode}`;
  const shareText = encodeURIComponent("I just joined the Eagle Eye Pro waitlist \u2014 real-time global intelligence powered by AI. Join me:");
  ...
  const telegramShare = `https://t.me/share/url?url=${shareUrl}&text=${encodeURIComponent('Join the Eagle Eye Pro waitlist:')}`;
  ...
  try {
    const resendRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: [email],
        subject: "You\u2019re on the Eagle Eye Pro waitlist",
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #e0e0e0;">
            ...
            <div style="padding: 40px 32px 0;">
              ...
              <div style="text-align: center; margin-bottom: 36px;">
                <a href="https://eagle-eye.app/dashboard" style="display: inline-block; background: #4ade80; color: #0a0a0a; padding: 14px 36px; text-decoration: none; font-weight: 800; font-size: 13px; text-transform: uppercase; letter-spacing: 1.5px; border-radius: 2px;">Explore the Free Dashboard</a>
            ...
            <div style="border-top: 1px solid #1a1a1a; padding: 24px 32px; text-align: center;">
              <div style="margin-bottom: 16px;">
                ...
                <a href="https://eagle-eye.app/pro" style="color: #666; text-decoration: none; font-size: 12px; margin: 0 12px;">Pro Waitlist</a>
              </div>
