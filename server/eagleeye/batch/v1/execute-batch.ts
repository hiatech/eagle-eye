...
import type {
  ...
  FieldViolation,
} from '../../../../src/generated/server/eagleeye/batch/v1/service_server';
import {
  ApiError,
  ValidationError,
} from '../../../../src/generated/server/eagleeye/batch/v1/service_server';
...
const FORWARDED_HEADERS = ['authorization', 'x-eagleeye-key', 'x-api-key', 'accept-language'] as const;
...
// The Cloudflare WAF in front of api.eagle-eye.app rejects generic
// user agents, so sub-requests always carry a descriptive one.
const DEFAULT_SUB_REQUEST_USER_AGENT =
  'EagleEye-Batch/1.0 (+https://www.eagle-eye.app/openapi.json)';
