...
description: "How EagleEye clusters FIRMS/VIIRS thermal detections, compares them with local baselines, and assigns thermal escalation status and relevance."
---
