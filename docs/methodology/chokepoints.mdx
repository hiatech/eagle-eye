...
description: "How Eagle Eye scores 13 monitored maritime chokepoints, including the seven-item live-flow subset backed by EIA energy baseline volumes."
---

## What we track

EagleEye has **13 monitored waterways** in the canonical chokepoint registry and the
...
`server/eagleeye/supply-chain/v1/get-chokepoint-status.ts` and weighted in
`server/eagleeye/supply-chain/v1/_scoring.mjs`.
...
[public repository](https://github.com/hiatech/eagle-eye/issues).
