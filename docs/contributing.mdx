---
title: "Contributing"
description: "Code style, pull-request process, contribution types, and security practices for contributors sending patches to the Eagle Eye project."
---
...
By contributing to Eagle Eye, you agree that your contributions are licensed under AGPL-3.0. See the [License](/license) page for full terms, commercial licensing, and common scenarios.
