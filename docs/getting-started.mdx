...
description: "Install, configure, and run Eagle Eye locally with a step-by-step setup guide covering the tech stack, project layout, and required API dependencies."
---
This guide covers everything you need to set up EagleEye locally, from prerequisites and installation to understanding the project structure and API dependencies.
...
EagleEye has three setup tracks depending on what you're doing.
