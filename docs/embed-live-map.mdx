...
description: "Embed the public Eagle Eye live map in an article, dashboard, or internal page with a single iframe snippet — sizing, params, and examples."
---

Eagle Eye exposes a public map-only iframe at `/embed`.
...
Each embed includes a permanent attribution link back to Eagle Eye with source campaign parameters.
