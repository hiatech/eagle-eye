...
Eagle Eye is mostly feed-first:
...
- [stock-news-search.ts](https://github.com/hiatech/eagle-eye/blob/main/server/eagleeye/market/v1/stock-news-search.ts)
...
- [runtime-config.ts](https://github.com/hiatech/eagle-eye/blob/main/src/services/runtime-config.ts)
- [settings-constants.ts](https://github.com/hiatech/eagle-eye/blob/main/src/services/settings-constants.ts)
- [main.rs](https://github.com/hiatech/eagle-eye/blob/main/src-tauri/src/main.rs)
- [local-api-server.mjs](https://github.com/hiatech/eagle-eye/blob/main/src-tauri/sidecar/local-api-server.mjs)
