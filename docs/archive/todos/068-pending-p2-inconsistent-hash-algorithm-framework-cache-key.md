...
- `server/eagleeye/intelligence/v1/get-country-intel-brief.ts:42-45` — uses `sha256Hex(frameworkRaw).slice(0, 8)` — SHA-256 (hex)
- `server/eagleeye/intelligence/v1/deduct-situation.ts` — uses `sha256Hex(framework).slice(0, 8)` — SHA-256
...
## Technical Details
- Files: `src/utils/summary-cache-key.ts:34`, `server/eagleeye/intelligence/v1/get-country-intel-brief.ts:42-45`
