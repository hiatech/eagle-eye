...
🌐 **[Live Demo: eagle-eye.app](https://eagle-eye.app)** | 💻 **[Tech Variant: tech.eagle-eye.app](https://tech.eagle-eye.app)**
...
![Eagle Eye Dashboard](images/new-eagle-eye.png)

## Platform Variants

Eagle Eye runs two specialized variants from a single codebase, each optimized for different monitoring needs:

| Variant | URL | Focus |
|---------|-----|-------|
| **🌍 Eagle Eye** | [eagle-eye.app](https://eagle-eye.app) | Geopolitical intelligence, military tracking, conflict monitoring, infrastructure security |
| **💻 Tech Monitor** | [tech.eagle-eye.app](https://tech.eagle-eye.app) | Technology sector intelligence, AI/startup ecosystems, cloud infrastructure, tech events |
...
The tech variant ([tech.eagle-eye.app](https://tech.eagle-eye.app)) provides specialized layers for technology sector monitoring.
...
The Service Status panel tracks the operational health of external services that Eagle Eye users may depend on.
...
// App.ts
const header = `Eagle Eye v${__APP_VERSION__}`;
```
...
- ✅ **Variant Switcher UI** - Compact orbital navigation between Eagle Eye and Tech Monitor
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/eagle-eye.git
   cd eagleeye
   ```
