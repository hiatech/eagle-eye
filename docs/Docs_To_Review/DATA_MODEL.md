...
Comprehensive data model documentation for **Eagle Eye** — an AI-powered real-time global intelligence dashboard. This reference covers all TypeScript interfaces, data structures, and their relationships across the system.
...
|-----|----------|--------------|
| `eagleeye-panel-spans` | `PANEL_SPANS_KEY` | `Record<string, number>` — panel ID → grid span (1–4) |
...
Database: `eagleeye_db`, version 1.
...
- Key prefix: `eagleeye-persistent-cache:`
