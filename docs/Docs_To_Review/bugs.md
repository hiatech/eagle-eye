...
**Description**
`PANEL_ORDER_MIGRATION_KEY` is `eagleeye-panel-order-v1.9` but the `console.log` says `"Migrated panel order to v1.8 layout"`.
...
**Description**
The Polymarket dev proxy targets `https://eagle-eye.app` (the live production site).
