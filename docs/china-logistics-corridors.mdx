...
| `power_energy` | EagleEye energy spine | National China energy dependency coverage, latest source observation time, and the observed year-over-year oil-product demand change with its own period end when published |
...
regional. EagleEye energy spine, UN Comtrade, and Shanghai Shipping
