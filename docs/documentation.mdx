...
- **Connect your own agent** via the [MCP server](/mcp-overview) — Claude, Cursor, and other MCP clients can call curated EagleEye tools over OAuth 2.1 or a direct API key
...
Eagle Eye is open source under [AGPL-3.0-only](/license). Commercial use is permitted under the AGPL when you comply with its copyleft and source-availability terms. Separate commercial licensing is available as an alternative option for private-source or custom contractual terms.
