---
title: "Eagle Eye privacy policy and data handling"
description: "How Eagle Eye handles personal data: what we collect, subprocessors, AI query processing, cookies, retention, and GDPR and CCPA access and deletion rights."
---
...
This Privacy Policy explains how Eagle Eye, based in Dubai, United Arab Emirates ("Eagle Eye", "we", "us"), handles information when you use the Eagle Eye dashboard, website, API, MCP server, and apps (the "Service").
...
**Payment information.** Subscriptions are processed by Dodo Payments, which acts as the merchant of record. Your full card details are entered with and held by the payment processor — **Eagle Eye never receives or stores your full card number.** We receive limited billing metadata (such as plan, status, country, and the last four digits) needed to manage your subscription.
...
Depending on where you live (including under the EU/UK GDPR and the California CCPA/CPRA), you may have the right to access, correct, export, or delete your personal data, and to object to or restrict certain processing. To exercise any of these rights, contact us at [support@eagle-eye.app](mailto:support@eagle-eye.app). You also have the right to complain to your local data protection authority.
...
Questions about this policy or your data: [support@eagle-eye.app](mailto:support@eagle-eye.app).
