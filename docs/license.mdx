...
This page is a plain-language summary for contributors and users. It is not legal advice and does not replace the license text in [`LICENSE`](https://github.com/hiatech/worldmonitor/blob/main/LICENSE).
...
Contact the maintainer through the [GitHub repository](https://github.com/hiatech/worldmonitor) to discuss commercial licensing.
