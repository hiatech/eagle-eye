...
description: "EagleEye REST compatibility guarantees, deprecation notices, and sunset signals for agents and long-lived integrations."
---

EagleEye versions public REST APIs in the URL:

```
https://api.eagle-eye.app/api/<domain>/v<major>/<operation>
```
...
Within a published major version, EagleEye may add optional request fields,
...
The bundled [OpenAPI specification](https://www.eagle-eye.app/openapi.yaml)
...
When EagleEye replaces or retires a public REST version or operation:
...
Link: <https://www.eagle-eye.app/docs/api-versioning>; rel="deprecation"; type="text/html"
```
