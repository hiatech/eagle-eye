# Eagle Eye — Community Promotion Guide

Thank you for helping spread the word about Eagle Eye! This guide provides talking points, must-see features, and visual suggestions to help you create compelling content for your audience.
...
**Longer description**: Eagle Eye aggregates 500+ news feeds, military tracking, financial markets, conflict data, protest monitoring, satellite imagery, and AI-powered analysis into a single unified dashboard with an interactive globe. Available as a web app, desktop app (macOS/Windows/Linux), and installable PWA.
...
| Link | Description |
|------|-------------|
| [eagle-eye.app](https://eagle-eye.app) | Main dashboard — geopolitics, military, conflicts |
| [tech.eagle-eye.app](https://tech.eagle-eye.app) | Tech variant — startups, AI/ML, cybersecurity |
| [finance.eagle-eye.app](https://finance.eagle-eye.app) | Finance variant — markets, exchanges, central banks |
| [commodity.eagle-eye.app](https://commodity.eagle-eye.app) | Commodity variant — mining, metals, energy, supply chains |
| [happy.eagle-eye.app](https://happy.eagle-eye.app) | Happy variant — positive news, breakthroughs, conservation |
| [energy.eagle-eye.app](https://energy.eagle-eye.app) | Energy variant — oil, gas, chokepoints, energy security |
| [GitHub](https://github.com/hiatech/eagle-eye) | Source code (AGPL-3.0) |
...
- **Name**: "Eagle Eye" (two words, capitalized)
- **Tagline**: "Real-time global intelligence dashboard"
- **License**: AGPL-3.0 (free and open source)
- **Creator**: Credit "Eagle Eye by Elie Habib" or link to the GitHub repo
...
We genuinely appreciate community members helping grow Eagle Eye's reach. Feel free to interpret these guidelines creatively — there's no strict template. The most compelling content comes from showing what YOU find most interesting or useful about the tool.
