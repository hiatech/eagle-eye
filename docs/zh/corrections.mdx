---
title: "修订日志（规划中）"
description: "规划中的 Eagle Eye 公开修订日志详情：将展示 Energy Atlas 注册表中每一次证据变更、数据来源更新、字段修正与公开徽标状态转换记录。本页描述规划形态、字段设计、数据模型与上线状态，日志本身尚未正式上线，仅作为透明度承诺与实现草案供参考。"
---
...
EagleEye 的 Energy Atlas 发布的是证据包 — 而非观点 —
...
- **每个资产上的证据包。** 点击 [Energy Atlas](https://energy.eagle-eye.app) 上的任何管道、储存
...
- 自动化的纠错提交流水线。如果您发现
  错误，请使用
  [eagle-eye.app](https://eagle-eye.app) 上的反馈渠道，或在
  [公开仓库](https://github.com/hiatech/eagle-eye/issues) 中提交 GitHub issue。
