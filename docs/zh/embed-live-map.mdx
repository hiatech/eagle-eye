---
title: "嵌入实时地图"
description: "只需一段 iframe 代码片段，即可将 Eagle Eye 公开的实时地图嵌入新闻文章、企业仪表盘、内部工具或作战室页面。本文档提供推荐尺寸、图层与主题参数、初始坐标缩放、深色模式、多种示例代码，以及常见集成场景的最佳实践与嵌入调优注意事项，帮助快速上线可交互态势地图。"
---

Eagle Eye 在 `/embed` 提供一个仅含地图的公开 iframe。
...
每个嵌入都包含一个指向 Eagle Eye 的永久归属链接，并带有来源活动参数。
