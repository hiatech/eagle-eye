...
description: "Catalogue of compact market-indicator, correlation, and misc signal panels — tight tile-style reads that complement Eagle Eye's deep-dive panels."
---

EagleEye ships many **tile-style** indicator, correlation, and signal panels — compact surfaces that show one or two readings each and are designed to be composed alongside the deep-dive panels. This page is the collective reference so each tile is findable without writing a dedicated page per panel.
