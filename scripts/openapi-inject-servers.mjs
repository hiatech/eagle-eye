 ...
 * only the BUNDLE (docs/api/eagleeye.openapi.yaml) gets one, via the
 ...
 *
 * The bundle (eagleeye.openapi.yaml) already carries `servers` from
...
const SERVER_URL = 'https://api.eagle-eye.app';
