 ...
 *   (default url: https://www.eagle-eye.app/dashboard; --cpu 1 = no throttle, matches Lighthouse desktop)
 */
...
export function parseArgs(argv) {
  const args = { url: 'https://www.eagle-eye.app/dashboard', cpu: 1, settle: 15000, json: false };
