...
// addition).
process.env.EAGLEEYE_VALID_KEYS = 'wm_measure_key';
...
async function fetchToolsList() {
  const req = new Request('https://eagle-eye.app/mcp', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json', 'X-EagleEye-Key': 'wm_measure_key' },
