...
console.log('  API_BASE_URL=https://api.eagle-eye.app EAGLEEYE_SEED_REFRESH_KEY=<seed-refresh-key> EAGLEEYE_API_KEY=<read-key> node scripts/seed-resilience-scores.mjs');
