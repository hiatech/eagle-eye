...
const mcpCountSurfaces = [
  ...
  'blog-site/src/content/blog/ask-claude-whats-happening-eagle-eye-mcp.md',
  'blog-site/src/content/blog/build-geopolitical-risk-agent-eagle-eye-mcp.md',
  ...
  'blog-site/src/content/blog/build-on-eagle-eye-developer-api-open-source.md',
  'blog-site/src/content/blog/eagle-eye-mcp-server-ai-agents-real-time-intelligence.md',
  'blog-site/src/content/blog/eagle-eye-is-not-palantir.md',
  ...
  return {
    ...
    plans: [
      ...
      },
      {
        name: 'Enterprise',
        price: 'Custom',
        contact: 'enterprise@eagle-eye.app',
...
transform('public/pricing.md', (source) => {
  ...
  if (!next.includes(generatedNote)) {
    next = next.replace('# Pricing - Eagle Eye\n', `# Pricing - Eagle Eye\n\n${generatedNote}\n`);
  }
  return next.replace(
    /```json\n[\s\S]*?```/,
...
transform('docs/docs.json', (source) => {
  ...
  const visit = (value) => {
    ...
    if (value.href === 'https://www.eagle-eye.app/pro#waitlist') {
