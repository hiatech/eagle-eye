...
const SERVICE_UA = 'eagleeye-llm/1.0';
...
const LLM_PROVIDERS = [
  ...
  },
  {
    ...
    headers: (key) => ({ 'Authorization': `Bearer ${key}`, 'Content-Type': 'application/json', 'HTTP-Referer': 'https://eagle-eye.app', 'X-Title': 'Eagle Eye', 'User-Agent': SERVICE_UA }),
    timeout: 20_000,
  },
];
