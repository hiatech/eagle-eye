...
import type { ListDiseaseOutbreaksResponse, DiseaseOutbreakItem } from '@/generated/client/eagleeye/health/v1/service_client';
...
// in server/eagleeye/health/v1/list-disease-outbreaks.ts so empty/offline
