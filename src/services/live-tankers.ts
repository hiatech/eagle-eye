...
//
// The handler-side cache (server/eagleeye/maritime/v1/get-vessel-snapshot.ts)
...
import type { SnapshotCandidateReport } from '@/generated/client/eagleeye/maritime/v1/service_client';
