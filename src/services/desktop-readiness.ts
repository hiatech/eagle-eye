...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiHandlers: ['server/eagleeye/conflict/v1/handler.ts', 'server/eagleeye/infrastructure/v1/handler.ts', 'server/eagleeye/cyber/v1/handler.ts', 'server/eagleeye/maritime/v1/handler.ts', 'server/eagleeye/military/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/eagleeye/news/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/eagleeye/market/v1/handler.ts'],
    locality: 'fully-local',
  ...
  },
  {
    ...
    apiHandlers: ['server/eagleeye/military/v1/handler.ts'],
    locality: 'api-key',
