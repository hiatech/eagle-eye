...
import type { Earthquake } from '@/generated/client/eagleeye/seismology/v1/service_client';
...
// Keep these aligned with server/eagleeye/intelligence/v1/_risk-config.ts.
