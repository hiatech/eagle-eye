...
const CW_PRO_GATE_TAB_RECOVERY_KEY = 'eagleeye-cw-pro-gate-tab-recovery-v1';
...
export class PanelLayoutManager implements AppModule {
  ...
  async renderLayout(): Promise<void> {
    ...
    const referenceLinksHtml = DASHBOARD_REFERENCE_LINKS.map(({ label, path }) => {
      const href = this.ctx.isDesktopApp ? `https://www.eagle-eye.app${path}` : path;
    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
            <a href="${vHref('full', 'https://eagle-eye.app/dashboard')}"
            ...
            <a href="${vHref('tech', 'https://tech.eagle-eye.app/dashboard')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('finance', 'https://finance.eagle-eye.app/dashboard')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('commodity', 'https://commodity.eagle-eye.app/dashboard')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('energy', 'https://energy.eagle-eye.app/dashboard')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('happy', 'https://happy.eagle-eye.app/dashboard')}"
          ...
          <span class="logo">MONITOR</span><span class="logo-mobile">Eagle Eye</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://x.com/eliehabib" target="_blank" rel="noopener" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">@eliehabib</span>
          </a>
          <a href="https://github.com/hiatech/eagle-eye" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">EAGLE EYE</span>
        ...
        <div class="mobile-menu-footer-links">
          ${referenceLinksHtml}
          <a href="${this.ctx.isDesktopApp ? 'https://www.eagle-eye.app/pro#pricing' : '/pro#pricing'}" target="_blank" rel="noopener">Pricing</a>
          <a href="${this.ctx.isDesktopApp ? 'https://eagle-eye.app/blog/' : 'https://www.eagle-eye.app/blog/'}" target="_blank" rel="noopener">Blog</a>
          <a href="${this.ctx.isDesktopApp ? 'https://eagle-eye.app/docs' : 'https://www.eagle-eye.app/docs'}" target="_blank" rel="noopener">Docs</a>
          <a href="https://status.eagle-eye.app/" target="_blank" rel="noopener">Status</a>
        </div>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">EAGLE EYE</span>
            <span class="site-footer-sub">v${__APP_VERSION__} &middot; <a href="https://x.com/eliehabib" target="_blank" rel="noopener" class="site-footer-credit">@eliehabib</a> &middot; <a href="https://github.com/hiatech/eagle-eye" target="_blank" rel="noopener" class="site-footer-credit">modified fork by Hiatech</a></span>
          </div>
        </div>
        <nav>
          ${referenceLinksHtml}
          ...
          <a href="${this.ctx.isDesktopApp ? 'https://eagle-eye.app/docs' : 'https://www.eagle-eye.app/docs'}" target="_blank" rel="noopener">Docs</a>
          <a href="https://status.eagle-eye.app/" target="_blank" rel="noopener">Status</a>
          <a href="https://github.com/hiatech/eagle-eye" target="_blank" rel="noopener">GitHub</a>
          <a href="https://discord.gg/re63kWKxaz" target="_blank" rel="noopener">Discord</a>
          <a href="https://x.com/eagleeyeai" target="_blank" rel="noopener">X</a>
          ${this.ctx.isDesktopApp ? '' : `<span id="footerDownloadMount"></span>`}
        </nav>
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} Eagle Eye</span>
      </footer>
  ...
  private insertByOrder(grid: HTMLElement, el: HTMLElement, key: string): void {
    ...
    for (let i = idx + 1; i < this.resolvedPanelOrder.length; i++) {
      ...
      // (EAGLEEYE-Q6). If the reference moved, fall through to the
