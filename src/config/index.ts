...
// VITE_VARIANT=tech → tech.eagle-eye.app (tech-focused)
// VITE_VARIANT=full → eagle-eye.app (geopolitical)
// VITE_VARIANT=finance → finance.eagle-eye.app (markets/trading)
