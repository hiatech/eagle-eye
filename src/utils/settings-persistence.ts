...
const SETTINGS_KEY_PREFIXES: readonly string[] = [
  ...
  'eagleeye-live-channels',
  'eagleeye-active-channel',
  'eagleeye-runtime-feature-toggles',
  'wm-globe-render-scale',
  'wm-live-streams-always-on',
  'eagleeye-webcam-prefs',
  'wm-map-theme:',
  'map-height',
  'map-pinned',
...
export function exportSettings(): void {
  ...
  const exportData: ExportedSettings = {
    ...
    variant: localStorage.getItem('eagleeye-variant') || 'full',
    data,
  };
  ...
  a.download = `eagleeye-settings-${ts}.json`;
