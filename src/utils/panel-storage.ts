export const PANEL_SPANS_KEY = 'eagleeye-panel-spans';
export const PANEL_COL_SPANS_KEY = 'eagleeye-panel-col-spans';
export const PANEL_COLLAPSED_KEY = 'eagleeye-panel-collapsed';
