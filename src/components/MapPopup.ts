...
function formatPositionSource(source: string): string {
  if (source === 'POSITION_SOURCE_WINGBITS') {
    return '<a href="https://wingbits.com?utm_source=eagleeye&utm_medium=referral&utm_campaign=eagleeye" target="_blank" rel="noopener" style="color:inherit">wingbits.com</a>';
  }
